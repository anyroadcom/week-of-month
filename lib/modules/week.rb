...
RUBY_VERSION < '1.9' ? require('modules/week_no_rails') : require_relative('week_no_rails')
...
module WeekOfMonth
  module Week
    ...
    unless Object.const_defined? :Rails
      include WeekOfMonth::WeekNoRails
    else
      def self.included(base)
        base.send(:alias_method, :previous_week, :prev_week)
      end
    end
